...
Hi {}, I'm a filter bot used for adding unlimited custom filter messages in groups.Join @botdouth to find how to add me in your group.
Check /help for more commends
...
Can be used by admins only:
 ...
 For more help, join @botdouth
"""

DONATE_STRING = """Heya, glad to hear you want to donate!
It took lots of work for [my creator](t.me/The_user_death) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better helping of childrens,and poor persons
so every little helps!
There are one ways of paying him; Google pay number- 7510207563."""
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),
                     ...
                     [InlineKeyboardButton(text="👨‍💻 ꜰɪʟᴛᴇʀ ᴅᴏᴜᴛʜ", url="https://t.me/botdouthbot"), InlineKeyboardButton(text="Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
    else:
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1158680997 and DONATION_LINK:
