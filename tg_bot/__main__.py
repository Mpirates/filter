...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("tg_bot.modules.misc.py" + module_name)
    if not hasattr(imported_module, "__misc__"):
        imported_module.__misc__ = imported_module.__name__

    if not imported_module.__misc__.lower() in IMPORTED:
        IMPORTED[imported_module.__misc__.lower()] = imported_module
    else:
        raise Exception("Can't have two modules with the same name! Please change one")

    if hasattr(imported_module, "__help__") and imported_module.__help__:
        HELPABLE[imported_module.__misc__.lower()] = imported_module
